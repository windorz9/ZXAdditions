...
@implementation UIColor (ZXAddition)
...
+ (instancetype)zx_colorWithHex:(uint32_t)hex {
    ...
    return [UIColor zx_colorWithRed:r green:g blue:b];
}


+ (instancetype)zx_randomColor {
    
    return [UIColor zx_colorWithRed:arc4random_uniform(256)
